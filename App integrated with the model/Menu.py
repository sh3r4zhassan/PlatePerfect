...
MENU = menu_dictionary = {
    "Deal 1-Pizza": ["pizza", "beverage"],
    "Deal 2-Soup": ["miso soup", "cold tofu", "fermented soybeans", "fermented soybeans"],
    "Deal 3-Miso Soup": ["miso soup", "cold tofu", "beverage"],
    "Deal 4-Hamburger With Fries": ["hamburger", "french fries", "beverage"],

}

MENU_PICTUERS = {
    "Deal 1-Pizza": __Image.open("pizza.jpg"),
    "Deal 2-Soup": __Image.open("90.jpg"),
    "Deal 3-Miso Soup": __Image.open("90.jpg"),
    "Deal 4-Hamburger With Fries": __Image.open("Hamburger.jpg"),
}
